...
smart words
camel case words
random character separated words ft;
-->
...
> all `word` motions listed above can be substituted with `WORD` motions (white space separated words)
...
`caf<space>`
: change including adjacent spaces
