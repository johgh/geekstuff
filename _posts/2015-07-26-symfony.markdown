...
$ ln -s ~/workspace/my_project_name/Web /var/www/
{% endhighlight %}
...
Important files and dir structure
: 
* Symfony config: `app/config/config.yml`
...
> [Dir structure explanation](https://symfony.com/doc/current/book/page_creation.html#exploring-the-project)
...
* For twig specific reference see [my twig doc](/twig/)
...
> Move assets (default to `Web`): php app/console assets:install target [--symlink]
