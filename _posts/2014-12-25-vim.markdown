...
# Basic .vimrc config file


> This is a basic .vimrc config file that should work on any modern Vim. For a more comprehensive config file, with functions and plugin configurations, see [here](https://github.com/johgh/vim)
...
" MAPPINGS {
    ...
    imap ñ <esc>
    cmap ñ <esc>
    " redefine insertion of ñ
    inoremap <leader><leader>ñ ñ
    cnoremap <leader><leader>ñ ñ
