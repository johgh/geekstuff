...
Es posible que en algunos casos el software *propietario* sea de mayor calidad que su alternativa *libre*, si bien ese no es siempre el caso. El software, como cualquier otra tecnología tiende al monopolio de forma natural. Esto es así debido a la tendencia inicial del usuario a rechazar cualquier software distinto al que ya conoce.

Por otra parte, la masiva aceptación del sistema *Android*, o la de los navegadores *Mozilla Firefox* y *Google Chrome*, son una clara prueba de que nada impide la rápida aceptación de *software libre* por parte de usuarios finales - esto es, si se dan las circunstancias adecuadas.

Por otro lado, no es menos cierto que a día de hoy, la gran mayoría de usuarios no valora - ni conoce en muchos casos - que es *software libre*. Una consecuencia directa de esto es que los sistemas de escritorio libres destinados a usuarios finales se hayan visto reducidos en gran parte a un nicho de usuarios técnicos. El usuario medio antepone multitud de criterios para seleccionar un software a la libertad con la que pueda usarlo finalmente, que generalmente, ni siquiera se plantea.

Así que mientras las grandes multinacionales parecen ser cada vez más conscientes del potencial del software libre, utilizándolo tanto en sus productos como en sus infraestructuras, esto no parece repercutir de forma alguna en las libertades del usuario final.

¿Y por qué no? El software sólo es una herramienta. Los individuos deben decidir el uso que le quieren dar. Y sólo decidiendo hacer un uso consciente del mismo serán libres para poder aprovechar todo su potencial.
