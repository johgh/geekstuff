...
## Surround
> [<i class="fa fa-external-link"></i> Github project](https://github.com/tpope/vim-surround)
...
## Multiple cursors
> [<i class="fa fa-external-link"></i> Github project](https://github.com/terryma/vim-multiple-cursors)
...
## Expand Region
> [<i class="fa fa-external-link"></i> Github project](https://github.com/terryma/vim-expand-region)
...
## Commentary
> [<i class="fa fa-external-link"></i> Github project](https://github.com/tpope/vim-commentary)
...
## Exchange
> [<i class="fa fa-external-link"></i> Github project](https://github.com/tommcdo/vim-exchange)
...
## DelimitMate
> [<i class="fa fa-external-link"></i> Github project](https://github.com/Raimondi/delimitMate)
...
## Utilsnips
> [<i class="fa fa-external-link"></i> Github project](https://github.com/SirVer/ultisnips)
...
## PhpDocumentor (PDV)
> [<i class="fa fa-external-link"></i> Github project](https://github.com/tobyS/pdv)

`<leader>c`
: call PDV snippet to doc function

## Abolish
> [<i class="fa fa-external-link"></i> Github project](https://github.com/tpope/vim-abolish)
