...
> [Directory tree explanation](https://symfony.com/doc/current/book/page_creation.html#exploring-the-project)
...
### Using services from a controller
{% highlight php startinline %}
{% raw %}
...
### Redirecting and url generation from controller
{% highlight php startinline %}
{% raw %}
public function indexAction()
{
...
### Url generation from javascript
...
> Move assets from a bundle to Public with: `app/console assets:install target --symlink`
