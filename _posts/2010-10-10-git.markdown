...
> La solución es hacer commit/stash, o utilizar git checkout --merge para mezclar a 3, dejando el resultado en el ```WORKING TREE``` de la rama nueva (p.74)
...
: {% highlight sh %}
    ...
    # crear hook que envíe mail con el nombre del feature a validar
{% endhighlight %}
